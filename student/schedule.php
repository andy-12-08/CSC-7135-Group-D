 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $sqlmain= "select * from schedule inner join tutor on schedule.tutorid=tutor.tutorid where schedule.scheduledate>='$today'  order by schedule.scheduledate asc";
                $sqlpt1="";
                $insertkey="";
                $q='';
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from schedule inner join tutor on schedule.tutorid=tutor.tutorid where schedule.scheduledate>='$today' and (tutor.tutorname='$keyword' or tutor.tutorname like '$keyword%' or tutor.tutorname like '%$keyword' or tutor.tutorname like '%$keyword%' or schedule.title='$keyword' or schedule.title like '$keyword%' or schedule.title like '%$keyword' or schedule.title like '%$keyword%' or schedule.scheduledate like '$keyword%' or schedule.scheduledate like '%$keyword' or schedule.scheduledate like '%$keyword%' or schedule.scheduledate='$keyword' )  order by schedule.scheduledate asc";
                            echo $sqlmain;
                            $insertkey=$keyword;
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Tutor name or Email or Date (YYYY-MM-DD)" list="tutors" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;

                                        <?php
                                            echo '<datalist id="tutors">';
                                            $list11 = $conn->query("select DISTINCT * from  tutor;");
