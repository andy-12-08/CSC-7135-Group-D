...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'fetch_single')
	{
		...
		foreach($result as $row)
		{
			$data['patient_email_address'] = $row['student_email_address'];
			$data['patient_password'] = $row['student_password'];
			$data['patient_first_name'] = $row['student_first_name'];
			$data['patient_last_name'] = $row['student_last_name'];
			$data['patient_date_of_birth'] = $row['student_date_of_birth'];
			$data['patient_gender'] = $row['student_gender'];
			$data['patient_address'] = $row['student_address'];
			$data['patient_phone_no'] = $row['student_phone_no'];
			$data['patient_maritial_status'] = $row['student_maritial_status'];
			if($row['email_verify'] == 'Yes')
			{
