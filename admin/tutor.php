...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-primary">Tutor List</h6>
                            	</div>
    	...
    	<form method="post" id="doctor_form">
      		<div class="modal-content">
        		<div class="modal-header">
                    <h4 class="modal-title" id="modal_title">Add Tutor</h4>
        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Tutor Email Address <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label>Tutor Password <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>Tutor Phone No. <span class="text-danger">*</span></label>
...
<div id="viewModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_title">View Tutor Details</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
    ...
    $(document).on('click', '.view_button', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                html += '<tr><th width="40%" class="text-right">Tutor Email Address</th><td width="60%">'+data.doctor_email_address+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Tutor Password</th><td width="60%">'+data.doctor_password+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Tutor Name</th><td width="60%">'+data.doctor_name+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Tutor Phone No.</th><td width="60%">'+data.doctor_phone_no+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Tutor Address</th><td width="60%">'+data.doctor_address+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Tutor Date of Birth</th><td width="60%">'+data.doctor_date_of_birth+'</td></tr>';
                html += '<tr><th width="40%" class="text-right">Tutor Qualification</th><td width="60%">'+data.doctor_degree+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Tutor Speciality</th><td width="60%">'+data.doctor_expert_in+'</td></tr>';
