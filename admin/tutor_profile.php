...
$(document).ready(function(){
    ...
    {
    ?>
    $('#hidden_id').val("<?php echo $row['tutor_id']; ?>");
    $('#doctor_email_address').val("<?php echo $row['tutor_email_address']; ?>");
    $('#doctor_password').val("<?php echo $row['tutor_password']; ?>");
    $('#doctor_name').val("<?php echo $row['tutor_name']; ?>");
    $('#doctor_phone_no').val("<?php echo $row['tutor_phone_no']; ?>");
    $('#doctor_address').val("<?php echo $row['tutor_address']; ?>");
    $('#doctor_date_of_birth').val("<?php echo $row['tutor_date_of_birth']; ?>");
    $('#doctor_degree').val("<?php echo $row['tutor_degree']; ?>");
    $('#doctor_expert_in').val("<?php echo $row['tutor_expert_in']; ?>");
    
    $('#uploaded_image').html('<img src="<?php echo $row["tutor_profile_image"]; ?>" class="img-thumbnail" width="100" /><input type="hidden" name="hidden_doctor_profile_image" value="<?php echo $row["tutor_profile_image"]; ?>" />');

    $('#hidden_doctor_profile_image').val("<?php echo $row['tutor_profile_image']; ?>");
    <?php
    }
    ?>
