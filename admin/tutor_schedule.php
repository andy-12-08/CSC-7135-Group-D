...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tutor Schedule Management</h1>
    	...
    	<form method="post" id="doctor_schedule_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Add Tutor Schedule</h4>
...
$(document).ready(function(){
	...
	$('#add_doctor_schedule').click(function(){
    	...
    	$('#modal_title').text('Add Tutor Schedule Data');
	...
	$(document).on('click', '.edit_button', function(){
		...
		console.log('edit button submitted!');
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text('Edit Tutor Schedule Data');
